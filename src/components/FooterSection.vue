<template>
     <section class="bg-gray-50 overflow-hidden">
        <div class="py-14 bg-black rounded-b-full"></div>
        <div class="py-24">
          <div class="container px-4 mx-auto">
            <div class="flex flex-wrap justify-center -m-8 mb-28">
              <div class="w-full md:w-1/2 lg:w-4/12 p-8">
                <div class="md:max-w-xs"><img class="mb-7" src="@/assets/image/logo2.png" alt=""/>
                  <p class="text-gray-400 font-medium">GAB International is a strategic branding agency focused on brand creation, rebrands, and brand</p>
                </div>
              </div>
                ...
                <div class="flex flex-wrap -m-2">
                  <div class="w-full p-2"><a class="block py-5 px-8 bg-white rounded-full" href="#">
                      <div class="flex flex-wrap items-center -m-2">
                        <div class="w-auto p-2"><img src="@/assets/template-assets/images/footers/twitter.svg" alt=""/></div>
                  ...
                  <div class="w-full p-2"><a class="block py-5 px-8 bg-white rounded-full" href="#">
                      <div class="flex flex-wrap items-center -m-2">
                        <div class="w-auto p-2"><img src="@/assets/template-assets/images/footers/instagram.svg" alt=""/></div>
                        <div class="flex-1 p-2">
                  ...
                  <div class="w-full p-2"><a class="block py-5 px-8 bg-white rounded-full" href="#">
                      <div class="flex flex-wrap items-center -m-2">
                        <div class="w-auto p-2"><img src="@/assets/template-assets/images/footers/tiktok.svg" alt=""/></div>
                        <div class="flex-1 p-2">
            ...
            <div class="flex flex-wrap justify-between -m-2">
              <div class="w-auto p-2">
                <p class="inline-block text-sm font-medium text-black text-opacity-60">© 2025 GAB </p>
              </div>
              <div class="w-auto p-2">
